...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-current/25 text-current opacity-80 transition-opacity hover:opacity-100"
    >
      {dark ? (
